package com.ultrapower.tomas.ui.dialog;
...
public class TimerProgressDialog extends ProgressDialog {
	...
	public TimerProgressDialog(Context context, int theme) {
		super(context, theme);
	}
	...
	public static TimerProgressDialog show(Context context) {
	...
	private Handler mHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			if (mTimeOutListener != null) {
				mTimeOutListener.onTimeOut(TimerProgressDialog.this);
				dismiss();
			}
		}
	};
	 ...
	 */
	public static TimerProgressDialog createProgressDialog(Context context,
			long time, OnTimeOutListener listener) {
		TimerProgressDialog progressDialog = new TimerProgressDialog(context,
				R.style.progressDialog);
		if (time != 0) {
	...
	public interface OnTimeOutListener {
		 ...
		 */
		abstract public void onTimeOut(TimerProgressDialog dialog);
	}
}
