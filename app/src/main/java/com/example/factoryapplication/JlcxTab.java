...
public class JlcxTab extends BaseFragment implements  AdapterView.OnItemClickListener ,OnClickListener {
...
//        dismissProcess();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(activity,JlcxActivityF.class) ;
